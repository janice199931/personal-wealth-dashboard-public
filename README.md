...
- 緊急預備金目標：`100000`
- 目標資產配置：台股 00685L `40%`、美股 QQQM `40%`、現金 `20%`
- 全部現金中先保留緊急預備金至少 `100000`，剩餘為投資預備金
- 首頁四個金庫：
  - 生活金庫（郵局）：`郵局餘額 + 現金 - 信用卡負債`
  - 投資金庫（永豐）：顯示全部現金扣掉緊急預備金後的投資預備金
  - 緊急預備金：永豐優先切出最多 `100000`
  - 投資預備金：全部現金扣掉 `100000` 緊急預備金後的剩餘金額
- 生活金庫若不足，不顯示 0，要顯示「短缺 $X」。
- 「投資總損益」是目前未實現損益。
